...
{
    $con=mysqli_connect ("localhost", 'root', '','cmcdb');
    if (!$con)
    {
    ...
    $latitude = mysqli_real_escape_string($con,$lat);
    $longitude = mysqli_real_escape_string($con,$lng);
    $descript = mysqli_real_escape_string($con,$description);

    $query = sprintf("insert into locations (id,lat, lng, description) values (NULL,'$latitude','$longitude','$descript');");
